    ...
    return (
        <>
            <div className="flex flex-col h-screen">
                <div className="overflow-y-scroll flex-1 mb-20 mac-scrollbar mac-scrollbar-x mac-scrollbar-y pr-4">
                    ...
                    <div className="flex">
                        <img src="./img/vector.png" alt="" className={`w-48 h-72 mt-14 transition-all duration-300 ${open ? "hidden" : ""}`} />
                    ...
                    <div className="flex w-full mt-6">
                        <div className={`pb-5 transition-all duration-300 ${open ? "w-[32rem]" : "w-[64%]"}`}>
                            <DashChart/>
                        </div>
                        <Card className="w-96 ml-auto bg-[#EDEDED] overflow-hidden py-0 ps-3 max-h-[366.5px]">
                            <CardBody className="pr-4 pb-0">
                                <Typography variant="h5" color="blue-gray" className="mb-0 flex">
                                    Approve Kehadiran
                                    <Button
                                        size="lg"
                                        variant="outlined"
                                ...
                                <div className="overflow-y-scroll mt-3 max-h-[290px] pr-4">
