...
import AuthContext from "../context-Api/AuthProvider.jsx"; // Import AuthContext
import { Input, Button } from "@material-tailwind/react";
import { Icon } from "@iconify/react";
import axios from "../api/axios.js"; // Pastikan path ini sesuai
import './Fonts.css';

const LOGIN_URL = "/login"; // Endpoint untuk login

function Login() {
  const { setAuth } = useContext(AuthContext); // Ambil setAuth dari AuthContext
            ...
            <div className="left-login pt-10 mr-28 w-5/12">
              ...
              <section>
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <Button type="submit" className="rounded-full bg-[#9D83C1] flex flex-col w-full items-center justify-center btn-login">
                    Submit
                  </Button>
                </form>
                <p className="mx-auto text-center pt-5 pb-5">
                  Belum punya akun? <a href="#" className="text-blue-500">Sign Up</a>
                </p>
              </section>
            </div>
